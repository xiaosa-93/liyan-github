...
// 柱状图2
(function(){
    var myColor=['#1089e7','#57474','#56d0e3','#f8b448','#8b78f6'];
...
(function(){
    ...
    var option={
        ...
        legend: {
            // 如果series有name值，则legend可以不用写data
            // 修改图例组件，文字颜色
            textStyle:{
                color:'#4c9bfd',
            },
    ...
    $('.line h2').on('click','a',function(){
        ...
        option.series[0].data=yearDate[index].data[0];
        option.series[1].data=yearDate[index].data[1];
